...
var ASTPathDispatcher, ASTPathResolver, ASTWalker, Base, Fragment, SymbolExtractor, TypeResolver, Vertex, namespace, _ref, _ref1, _ref2, _ref3,
...
ASTPathResolver = (function() {
  ...
  ASTPathResolver.prototype.resolve = function(root, path) {
    var current, next, next_id, next_type, node, nodes, root_node, _i, _len;
...
ASTPathDispatcher = (function() {
  ...
  ASTPathDispatcher.prototype.dispatch = function(node) {
    var callback, path, _ref, _results;
    _ref = this.map;
    _results = [];
    for (path in _ref) {
      callback = _ref[path];
      node = this.resolver.resolve(node, path);
      if (node != null) {
        _results.push(typeof callback === "function" ? callback(node) : void 0);
      } else {
...
Vertex = (function(_super) {
  ...
  function Vertex() {
    _ref2 = Vertex.__super__.constructor.apply(this, arguments);
    return _ref2;
  }
...
Fragment = (function(_super) {
  ...
  function Fragment() {
    _ref3 = Fragment.__super__.constructor.apply(this, arguments);
    return _ref3;
  }
...
namespace = function(target, name, block) {
  var item, top, _i, _len, _ref4, _ref5;
  if (arguments.length < 3) {
    _ref4 = [(typeof exports !== 'undefined' ? exports : window)].concat(__slice.call(arguments)), target = _ref4[0], name = _ref4[1], block = _ref4[2];
  }
  top = target;
  _ref5 = name.split('.');
